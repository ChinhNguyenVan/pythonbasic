...
# Kết quả: False
# 11, isalpha().
# Hàm này có tác dụng kiểm tra xem một chuỗi có phải là chứa duy nhất các ký tự chữ hay không? 
# Nó sẽ trả về True nếu chuỗi này chỉ chứa duy các ký tự chữ trong bảng chữ cái, và sẽ trả về False 
# nếu nó chứa số hoặc ký tự đặc biệt khác.
...
# Kết quả: True
# 12, isdigit().
# Hàm này có tác dụng kiểm tra xem một chuỗi có phải là chứa duy nhất các chữ số hay không?
...
# Kết quả: True
# 13, islower().
# Hàm này có tác dụng kiểm tra xem một chuỗi có phải là in thường hay không? Nó sẽ trả về True nếu đúng 
# và False nếu sai.
...
# 14, isupper().
# Hàm này có tác dụng kiểm tra xem một chuỗi có phải là in Hoa hay không? Nó sẽ trả về True nếu đúng 
# và False nếu sai.
...
# 15, isnumeric()
# Hàm này có tác dụng kiểm tra xem một chuỗi có phải chỉ chứa duy nhất các ký tự số hay không?
# Nó sẽ trả về True nếu đúng và False nếu sai.
...
# 16, isspace().
# Hàm này có tác dụng kiểm tra xem một chuỗi có phải chỉ chứa duy nhất các ký tự khoảng trắng không? 
# Nó sẽ trả về True nếu đúng và False nếu sai.
...
# Kết quả: Vu Thanh Tai
# 27, rfind().
# Tương tự như hàm find(), nhưng hàm này nó sẽ trả về index của chuỗi cuối cùng tìm được trong chuỗi.
...
# 28, rindex().
# Tương tự như hàm index(),nhưng hàm này nó sẽ trả về index của chuỗi cuối cùng tìm được trong chuỗi. 
